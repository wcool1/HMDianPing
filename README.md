...
- [KNeegcyao/dianping: 黑马点评完整代码+简历编写+面试重点 ⭐](https://github.com/KNeegcyao/dianping)
- [haopengmai/dianping: 黑马点评项目优化，新增消息队列RabbitMQ，令牌桶限流实现优惠券秒杀，用户登录限流(redis实现滑动窗口)等功能](https://github.com/haopengmai/dianping)
